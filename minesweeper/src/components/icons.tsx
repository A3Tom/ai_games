...
export const Flag: React.FC<IconProps> = ({ size = 16, className = '' }) => (
...
export const Bomb: React.FC<IconProps> = ({ size = 18, className = '' }) => (
...
export const Skull: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
